              ...
              <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                      ...
                      <tr>
                        <td class="content-cell">
                          <div class="f-fallback">
                            <h1>Hi ${name},</h1>
                            <p>You recently added by bonic teams <strong>Create  your password by clicking the below button to be a part of our team</strong><br/><em><b>This email will be expired in 1hr</b></em></p>
                            <!-- Action -->
               ...
               https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                    <tr>
                                      <td align="center">
                                        <a href="${url}" class="f-fallback button button--green" target="_blank">Create your password</a>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                            ...
                            <p>After creating your password upload your verification documents to approved </p>
                            <p>Thanks,
                              <br>The Bonic team</p>
                            <!-- Sub copy -->
